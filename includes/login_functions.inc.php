 ...
 * This function takes one argument: the page to be redirected to.
...
function redirect_user($page = 'index.php') {
    ...
    //URL is http:// plust the host name plust the current directory:
...
function check_login($dbc, $email = '', $pass = '') {
    ...
    if (empty($errors)) {  // If everything's OK.
        ...
        // Retrieve the user_id and first_name for that email/password combination:
            $q = "SELECT user_id, first_name, last_name, email, user_level FROM customers WHERE email='$e' AND pass=SHA2('$p', 512) AND active IS NULL";
