...
<body>
	...
	<h4 style="font-family: 'Jost', sans-serif; text-align: center;">We address both the need for long-term preparedness and the desire for immediate gardening success.</h4>

	<h3 class="my-2">Ultimate Seed Security</h3>

	<p>We believe true freedom starts with food independance. Our package collections are not just seeds;
		they are a life-sustaining investment, packaged for maximum shelf life and genetic diversity. In a crisis, your most valuable
	...
	<ul class="my-2">
		<li><strong>Long-Term Storage:</strong> Seeds packaged for three years of optimal viability.</li>
	...
	<h3 class="my-2">Guaranteed Regional Success</h3>
